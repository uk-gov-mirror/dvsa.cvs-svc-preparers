...
podTemplate(label: label, containers: [
    containerTemplate(name: 'dynamodb',
                      ...
                      command: 'java -jar /home/dynamodblocal/DynamoDBLocal.jar -inMemory -sharedDb -port 8006',
                      ports: [portMapping(name: 'dynamoport', containerPort: 8006, hostPort: 8006)]),
        ...
        container('node'){
            ...
            stage("upload to s3") {
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding',
                  ...
                  sh "aws s3 cp ${LBRANCH}.zip s3://cvs-services/preparers/${LBRANCH}.zip --metadata sha256sum=\"\$(openssl dgst -sha256 -binary ${LBRANCH}.zip | openssl enc -base64)\""
                }
            }
        }
    }
